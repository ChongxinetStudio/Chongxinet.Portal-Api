...
public class SendMail {
	...
	public static MimeMessage createMimeMessage(Session session,
		...
		// 2. From: 发件人
		message.setFrom(new InternetAddress(sendMail, "徐坤帅", "UTF-8"));

		// 3. To: 收件人（可以增加多个收件人、抄送、密送）
		message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(
				receiveMail, "头儿", "UTF-8"));

		// 4. Subject: 邮件主题
		message.setSubject("测试成功", "UTF-8");

		// 5. Content: 邮件正文（可以使用html标签）
		message.setContent("头儿，我的java发邮件功能写完了", "text/html;charset=UTF-8");
